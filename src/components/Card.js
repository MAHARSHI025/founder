...
function Card() {
  ...
  // At this point, user is authenticated for sure (middleware guarantees this).
      ...
      <div className="profile-card flex justify-center items-center flex-col bg-white shadow-md rounded-2xl max-w-sm mx-auto ">
        <div className="flex flex-col ">
          ...
          <div className="flex profile-image items-end p-1">
            <img
              className="h-20 w-20 bg-cover rounded-full border-2 border-white object-cover"
              loading='lazy'
          ...
          <div className='flex justify-between items-center'>
            ...
            <h3 className='font-light text-xs text-gray-500 mt-10 mr-6'>
              Contact by {user?.likecount}
            </h3>
          </div>
          <button className="bg-black p-2 rounded-2xl text-white mt-2 cursor-pointer">
            Contact us
          </button>
        </div>
      </div>
